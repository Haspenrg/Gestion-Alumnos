...
// --- INTEGRACIÓN SÍNCRONA DE CREDENCIALES COMPARTIDAS (CRÍTICO) ---
...
// --- INTERCEPCIÓN MODULAR PARA BOLETINES EN LOTE REFACTORIZADO ---
if ( tipo === 'BOLETIN') {
if ( window.firebaseConfig) {
localStorage.setItem('firebaseConfig', JSON.stringify( window.firebaseConfig));
} else {
...
// --- LÓGICA TRADICIONAL PARA INFORMES PEDAGÓGICOS EN LOTE ---
