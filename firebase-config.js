...
// Inicializar la base de datos con motor de persistencia local en caché habilitado
export const db = mStore.initializeFirestore(app, {
  localCache: mStore.persistentLocalCache({
    tabManager: mStore.persistentMultipleTabManager() // Permite que funcione en varias pestañas a la vez
  })
});
